...
import com.blk.uhabits.BuildConfig;
import com.blk.uhabits.commands.Command;

public abstract class DialogHelper
{

    public static final String BLK_NAMESPACE = "http://com.blk/android";
    ...
    {
        int resId = attrs.getAttributeResourceValue(BLK_NAMESPACE, name, 0);

        if (resId != 0) return context.getResources().getString(resId);
        else return attrs.getAttributeValue(BLK_NAMESPACE, name);
    }
